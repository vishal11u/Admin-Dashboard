                ...
                <List component="div" disablePadding>
                    {subMenus.map((subMenu) => (
                        <ListItem key={subMenu.id} disablePadding
                            sx={{ pl: 4 }} component={Link} to={subMenu.routerLink}>
                            <ListItemButton>
                                <ListItemIcon>
                                    <MailIcon />
                                </ListItemIcon>
...
export default function MyDrawer() {
            ...
            {items.map((item) => (
                <React.Fragment key={item.id}>
                    {item.subMenus ? (
                        ...
                        <ListItem key={item.id} disablePadding component={Link} to={item.routerLink} sx={{ display: "block" }}>
                            <ListItemButton sx={{ minHeight: 48, justifyContent: openDrawer ? "initial" : "center", px: 2.5, }}>
                                <ListItemIcon
                                    sx={{ minWidth: 0, mr: openDrawer ? 3 : "auto", justifyContent: "center", }} >
                                ...
                                <ListItemText primary={item.functionality} sx={{ opacity: openDrawer ? 1 : 0 }} />
                            </ListItemButton>
                        </ListItem>
                    )}
                </React.Fragment>
    ...
    return (
        <>
            ...
            <Box sx={{ display: "flex" }}>
                <CssBaseline />
                <AppBar position="fixed" openDrawer={openDrawer} style={{ backgroundColor: "#6f00ff" }}  >
                    <Toolbar>
                        <IconButton color="inherit" aria-label="openDrawer drawer"
                            onClick={handleDraweropenDrawer} edge="start"
                            sx={{
                                marginRight: 5,
                        ...
                        <div className="w-full mr-4">
                            <AppBarMenu setOpenDrawer={setOpenDrawer} />
                        </div>
                    </Toolbar>
                </AppBar>
                ...
                <Box component="main" sx={{ flexGrow: 1, p: 1 }}>
                    ...
                    <Routes>
                        ...
                        <Route path="/feedbackregistration" element={<FeedBackRegistration />} />
                        <Route path="/employeefeedback" element={<EmployeeFeedback />} />
                        <Route path="/masters/answerreview" element={<AnswerReviewCreation />} />
                        <Route path="/masters/feedback" element={<FeedBackQuestionSetCreation />} />
